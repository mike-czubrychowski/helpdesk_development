class TicketStatisticsController < ApplicationController
  ...
  def index
    @ticket_statistics = TicketStatistic.all
  end
  ...
  def new
    @ticket_statistic = TicketStatistic.new
  end
  ...
  def create
    @ticket_statistic = TicketStatistic.new(ticket_statistic_params)
  ...
  private
    ...
    def set_ticket_statistic
      @ticket_statistic = TicketStatistic.find(params[:id])
    end

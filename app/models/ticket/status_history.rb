class Ticket::StatusHistory < ActiveRecord::Base
	...
	belongs_to :ticket_detail, class_name: "Ticket::Detail", foreign_key: "ticket_detail_id", inverse_of: :ticket_status_histories
	belongs_to :ticket_status, class_name: "Ticket::Status", foreign_key: "ticket_status_id"
